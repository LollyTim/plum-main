      ...
      <main className="flex-grow">
          ...
          <div className="container mx-auto px-6">
            <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
              <div className="lg:col-span-2">
                <div className="bg-white rounded-xl shadow-md p-8">
                  ...
                  <form onSubmit={handleSubmit} className="space-y-6">
                    ...
                    <Button type="submit" className="w-full bg-gold-400 hover:bg-gold-500 text-white">
                      Send Message
                    </Button>
                  </form>
                </div>
              ...
              <div>
                <div className="bg-white rounded-xl shadow-md p-8">
                  ...
                  <div className="space-y-6">
                    <ContactInfo
                      ...
                      title="Our Location"
                      description="123 Plum Street, Suite 101, Lagos, Nigeria"
                    />
                    ...
                    <ContactInfo
                      ...
                      title="Email Address"
                      description="info@plumgifts.com"
                    />
                ...
                <div className="mt-8 bg-gold-50 rounded-xl shadow-md p-8">
                  <h3 className="text-xl font-bold mb-4">Connect With Us</h3>
                  <p className="text-gray-600 mb-4">
                    Follow us on social media for updates on new products, special promotions, and more.
                  </p>
        ...
        <section className="py-16 bg-gray-50">
          <div className="container mx-auto px-6">
            ...
            <div className="bg-white rounded-xl shadow-md p-2 overflow-hidden">
